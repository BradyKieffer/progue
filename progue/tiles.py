...
TILES = {
    ...
    TILE_WALL:   Tile(glyph='#',                  fore_color=libtcod.dark_gray,   back_color=libtcod.black,       passable=False),
    TILE_SAND:   Tile(glyph=SPARSE_DOTTED_SQUARE, fore_color=libtcod.light_sepia, back_color=libtcod.black,       passable=True ),
    TILE_WATER: [
                 Tile(glyph='~',                  fore_color=libtcod.blue,        back_color=libtcod.darker_blue, passable=False),
                 Tile(glyph=' ',                  fore_color=libtcod.blue,        back_color=libtcod.darker_blue, passable=False),
                 Tile(glyph=' ',                  fore_color=libtcod.blue,        back_color=libtcod.darker_blue, passable=False),
                 Tile(glyph=' ',                  fore_color=libtcod.blue,        back_color=libtcod.darker_blue, passable=False),
                 Tile(glyph=APPROX_EQUAL_SIGN,    fore_color=libtcod.blue,        back_color=libtcod.darker_blue, passable=False),
    ],
}
